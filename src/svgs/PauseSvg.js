    ...
    return (
        <svg viewBox="0 0 52 50">
            <path 
                ...
                className="svgs-light-stroke svgs-transparent-fill"    
            />
            <path 
            ...
            <path 
                ...
                style={{ opacity: artworks.slideshowPlaying ? 0 : 1}}
            />
            <rect 
                x="11" y="10" width="10" height="26" fill="white"
                style={{ opacity: artworks.slideshowPlaying ? 1 : 0}}
            />
            <rect 
                x="25" y="10" width="10" height="26" fill="white"
                style={{ opacity: artworks.slideshowPlaying ? 1 : 0}}
            />
        </svg>
    )
