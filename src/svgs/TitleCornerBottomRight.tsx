...
const TitleCornerBottomRight = () => {
    ...
    return (
        <svg width="10" height="10">
            {viewState === 'desktop' && <polygon points="0,10 0,0 10,0" />}
            ...
            {viewState === 'slideshow' && <line x1="0" y1="0" x2="10" y2="0" stroke={titleDark} strokeWidth="1" />}
            {viewState === 'slideshow' && <line x1="10" y1="0" x2="10" y2="10" stroke={titleDark} strokeWidth="1" />}
        </svg>
    )
}
