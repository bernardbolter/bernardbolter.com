interface ArtworkPauseSvgProps {
    artworkPlaying: boolean,
    setArtworkPlaying: (playing: boolean) => void
}

const ArtworkPauseSvg = ({ artworkPlaying, setArtworkPlaying }: ArtworkPauseSvgProps) => {
    ...
    return (
        ...
        >
            ...
            <rect
                className="svgs-dark-fill"
                x="11" y="10" width="10" height="26"
                style={{ opacity: artworkPlaying ? 1 : 0}}
            />
            <rect
                className="svgs-dark-fill"
                x="25" y="10" width="10" height="26"
                style={{ opacity: artworkPlaying ? 1 : 0}}
            />
        </svg>
    )
...
export default ArtworkPauseSvg;